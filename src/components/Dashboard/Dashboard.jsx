    ...
    <div className="dashboard">
      ...
      <div className="pie-charts">
        <div className="chart-container">
          ...
          <Pie data={{ labels: ['Income', 'Expenses'], datasets: [{ label: 'Money Flow', data: [totalIncome, totalExpense], backgroundColor: ['#4caf50', '#f44336'], hoverOffset: 4 }] }} />
        </div>
        <div className="chart-container">
          <h3>Income Breakdown</h3>
          <Pie data={{ labels: Object.keys(incomeCategories), datasets: [{ label: 'Income Breakdown', data: Object.values(incomeCategories), backgroundColor: ['#4caf50', '#8bc34a', '#cddc39', '#ffeb3b'], hoverOffset: 4 }] }} />
        </div>
        <div className="chart-container">
          <h3>Expense Breakdown</h3>
          <Pie data={{ labels: Object.keys(expenseCategories), datasets: [{ label: 'Expense Breakdown', data: Object.values(expenseCategories), backgroundColor: ['#f44336', '#e57373', '#ffcdd2', '#ff7043'], hoverOffset: 4 }] }} />
        </div>
      </div>
    </div>
  );
